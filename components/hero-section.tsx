      ...
      <div className="relative mx-auto max-w-7xl px-6 py-20 lg:py-32">
        <div className="text-center">
          ...
          <p className="mx-auto max-w-4xl text-lg leading-8 text-white/90 sm:text-xl font-medium mb-12">
            Track, benchmark, and improve your mentions across ChatGPT, Gemini, Claude, 
            and Perplexity with enterprise-grade analytics and actionable insights.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button size="lg" className="bg-white text-brand-purple-700 hover:bg-gray-50 font-semibold px-8 py-4 text-base shadow-xl hover:shadow-2xl transition-all duration-200">
              Request Demo
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-brand-purple-700 font-semibold px-8 py-4 text-base transition-all duration-200">
              Sign In
            </Button>
          </div>
        </div>
