          ...
          <CardContent className="p-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {platforms.map((platform, _index) => (
                <Card
                  key={platform.name}
                  className="group border-0 hover:shadow-2xl transition-all duration-500 bg-white rounded-2xl overflow-hidden"
                >
                  <CardContent className="p-6 text-center relative">
                    ...
                    <div className="relative mb-6">
                      <div
                        className={`w-20 h-20 mx-auto flex items-center justify-center rounded-2xl shadow-lg border border-white/50 group-hover:shadow-xl transition-all duration-300 ${platform.bgColor} group-hover:scale-105`}
                      >
