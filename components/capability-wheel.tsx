            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {capabilities.map((capability, _index) => (
                <Card
                  ...
                  className="relative border-0 hover:shadow-2xl transition-all duration-500 group overflow-hidden bg-white shadow-xl"
                >
                  <div
                  ...
                  <CardContent className="p-8 relative z-10 text-center">
                    <div className="mb-8">
                      <div
                        className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${capability.gradient} mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                      >
