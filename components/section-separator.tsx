interface SectionSeparatorProps {
  variant?: 'gradient' | 'dots' | 'waves' | 'geometric' | 'glow' | 'custom' | 'cool'
}
      ...
      <div className="relative h-16 bg-white overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative">
            <div className="w-8 h-8 border border-brand-purple-300/30 rotate-45 animate-spin" style={{ animationDuration: '20s' }} />
            <div className="absolute inset-1 w-6 h-6 border border-brand-blue-300/30 rotate-45 animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
            <div className="absolute inset-2 w-4 h-4 border border-neutral-300/50 rotate-45 animate-spin" style={{ animationDuration: '10s' }} />
          </div>
        </div>
        <div className="absolute left-1/4 top-1/2 w-1 h-1 bg-brand-purple-300/50 rounded-full animate-pulse" />
        <div className="absolute right-1/4 top-1/3 w-1 h-1 bg-brand-blue-300/50 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute left-1/3 bottom-1/3 w-1 h-1 bg-neutral-300/70 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
    )
  }
